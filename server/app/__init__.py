...
def create_app():
	...
	from app.api.users.models import UserRegisterApi, UserLoginApi, UserLogoutApi, UserApi, AdminUserApi, AdminSysSettingApi
	...
	api.add_resource(AdminUserApi, "/api/v1/admin/user")
	api.add_resource(AdminSysSettingApi, "/api/v1/admin/sys")
